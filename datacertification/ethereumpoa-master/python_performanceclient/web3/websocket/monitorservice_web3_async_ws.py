...
web3 = Web3(Web3.WebsocketProvider(geth_ws, websocket_kwargs={'timeout': 100}))
...
def sendTransaction():
   ...
   for i in range (0,100000):
    threadinstance = Thread(target=threadfunction,args=(i,account,maincontractaddress,totalnonce,maincontractfunctionabi,totalresult))
...
def getTransaction():
   with open("web3_async_ws.csv","w") as csvfile:
