...
function publishSign(transactionkey, permissionaddress, callback) {
    ...
    multichain.grantWithMetadata({
        ...
        multichain.grantWithMetadata({
            addresses: permissionaddress,
            permissions: 'adminpermissionrequest.send',
            data: {
                "json": 'Admin approve'
            }
        }, (error, response) => {
            if (error) {
             ...
             multichain.grantWithMetadata({
            addresses: permissionaddress,
            permissions: 'adminpermissionrequest.receive',
            data: {
                "json": 'Admin approve'
            }
        }, (error, response) => {
                    ...
                    multichain.grantWithMetadata({
                        ...
                        multichain.grantWithMetadata({
                            ...
                            if (error) {
                             ...
                             multichain.grantWithMetadata({
                            addresses: permissionaddress,
                            permissions: 'permissionrequest.send',
                            data: {
                                "json": 'Admin approve'
                            }
                        }, (error, response) => {
                            ...
                            multichain.grantWithMetadata({
                            addresses: permissionaddress,
                            permissions: 'permissionrequest.receive',
                            data: {
                                "json": 'Admin approve'
                            }
                        }, (error, response) => {
                            ...
                            multichain.grantWithMetadata({
                                ...
                                multichain.grantWithMetadata({
                                    ...
                                    multichain.grantWithMetadata({
                                        ...
                                        multichain.grantWithMetadata({
                                        addresses: permissionaddress,
                                        permissions: 'permissionapprove.send',
                                        data: {
                                            "json": 'Admin approve'
                                        }
                                    }, (error, response) => {
                                        ...
                                        multichain.grantWithMetadata({
                                        addresses: permissionaddress,
                                        permissions: 'permissionapprove.receive',
                                        data: {
                                            "json": 'Admin approve'
                                        }
                                    }, (error, response) => {
                                            ...
                                            multichain.grantWithMetadata({
                                                ...
                                                multichain.grantWithMetadata({
                                                    ...
                                                    if (error) {
                                                     ...
                                                     multichain.grantWithMetadata({
                                                    addresses: permissionaddress,
                                                    permissions: 'assetapprove.receive',
                                                    data: {
                                                        "json": 'Admin approve'
                                                    }
                                                }, (error, response) => {
                                                                            ...
                                                                            multichain.grantWithMetadata({
                                                                                ...
                                                                                multichain.grantWithMetadata({
                                                                                    ...
                                                                                    if (error) {
                                                                                     ...
                                                                                     multichain.grantWithMetadata({
                                                                                    addresses: permissionaddress,
                                                                                    permissions: 'assetrequest.receive',
                                                                                    data: {
                                                                                        "json": 'Admin approve'
                                                                                    }
                                                                                }, (error, response) => {
        ...
        multichain.getAddresses({
            ...
            if (addresserr) {
                ...
                multichain.listStreamKeys({
                    ...
                    for (let i = 0,p=Promise.resolve(); i < Object.keys(pendingTransaction).length; i++) {
                        //9*10^16
                        p=p.then(_=>new Promise(resolve =>{
...
function getPendingFulfilledTransaction(AdminPeers, PermissionRequests) {
    ...
    for (let i = 0; i < Object.keys(AdminPeers).length; i++) {
        for (let j = 0; j < Object.keys(PermissionRequests).length; j++) {
