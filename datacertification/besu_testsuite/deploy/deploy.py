...
from config import RPCaddress_http_miner1, CONTRACT_SOURCE, CONTRACT_ABI, CONTRACT_ADDRESS
...
def testMethods(myContract):
    ...
    answer = myContract.functions.admin_counter().call()
...
if __name__ == '__main__':
    ...
    w3, chainInfos = web3connection(RPCaddress=RPCaddress_http_miner1, account=None)
